...
class Detect(nn.Module):
    ...
    def forward(self, x):
        ...
        - Adapted to wrok with Vitis AI (Since the permute and view are not supported in the Vitis-AI 3.0)
        the last layer was removed in the detection head and reimplement that last layer in the post-processing section.
